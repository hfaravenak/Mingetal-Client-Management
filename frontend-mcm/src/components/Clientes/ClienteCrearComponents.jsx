            ...
            <div className="container-create">
               <Form onSubmit={handleSubmit}>
                  <Form.Group controlId="rut">
                     ...
                     <Form.Control type="text" name="rut" value={input.rut} onChange={handleInputChange} placeholder="12.345.678-9" required />
                     {errors.rut && <span className="text-danger">{errors.rut}</span>}
                  </Form.Group>

                  <Form.Group controlId="nombre">
                     <Form.Label>Nombre:</Form.Label>
                     <Form.Control type="text" name="nombre" value={input.nombre} onChange={handleInputChange} placeholder="Juan Perez" required />
                     {errors.nombre && <span className="text-danger">{errors.nombre}</span>}
                  </Form.Group>

                  <Form.Group controlId="empresa">
                     <Form.Label>Empresa:</Form.Label>
                     <Form.Control type="text" name="empresa" value={input.empresa} onChange={handleInputChange} placeholder="EmpresaX" required />
                     {errors.empresa && <span className="text-danger">{errors.empresa}</span>}
                  </Form.Group>

                  <Form.Group controlId="telefono">
                     <Form.Label>Telefono:</Form.Label>
                     <Form.Control type="text" name="telefono" value={input.telefono} onChange={handleInputChange} placeholder="+569 1234 5678" required />
                     {errors.telefono && <span className="text-danger">{errors.telefono}</span>}
                  </Form.Group>

                  <Form.Group controlId="correo">
                     <Form.Label>Correo:</Form.Label>
                     <Form.Control type="email" name="correo" value={input.correo} onChange={handleInputChange} placeholder="correfake@gmail.com" required />

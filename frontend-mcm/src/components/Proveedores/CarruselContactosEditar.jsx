    ...
    return (
        ...
        <NavStyle>
            ...
            <Form onSubmit={handleSubmit}>
                                ...
                                return(
                                    <div className="card" key={index}>
                                        ...
                                        <div className="contenedor-informacion">
                                            <Form.Group className="mb-3" controlId="contactos">
                                            ...
                                            <Form.Group className="mb-3" controlId="empresa" style={{marginTop:"2.2%"}}>
                                            ...
                                            <Form.Group className="mb-3" controlId="correo">
                                                ...
                                                <Form.Control type="text" name="correo" value={input.contactos[index].correo} onChange={(event) => handleInputChange(event, index)} placeholder="abcedg@correo.com" className="font-h2-control no-border"/>
                                            </Form.Group>
                                            <Form.Group className="mb-3" controlId="telefono_celular" style={{marginTop:"2.2%"}}>
                                                <Form.Label className="font-h2">Telefono Celular:</Form.Label>
                                                <Form.Control type="text" name="fono_cel" value = {input.contactos[index].fono_cel} onChange={(event) => handleInputChange(event, index)} placeholder="+569 12345678" className="font-h2-control no-border" style={{width:"150px"}}/>
                                            </Form.Group>
                                            <Form.Group className="mb-3" controlId="telefono_fijo">
                                                <Form.Label className="font-h2">Telefono Fijo:</Form.Label>
                                                <Form.Control type="text" name="fono_fijo" value = {input.contactos[index].fono_fijo} onChange={(event) => handleInputChange(event, index)} placeholder="22 12345678" className="font-h2-control no-border" style={{width:"150px"}}/>
                                            </Form.Group>
                                            <Form.Group className="mb-3" controlId="comentario" style={{marginBottom:"2.2%"}}>
                                                <Form.Label className="font-h2">Comentario:</Form.Label>
                                                <p></p>
                                                <Form.Control rows={3} as="textarea" name="comentario" value = {input.comentario} onChange={handleInputChange} className="font-h2-control no-border" style={{width:"95%", marginLeft:"4%"}}/>
                                            </Form.Group>
                                        </div>
                                    </div>
                                )
                ...
                <Button className="aceptar" type="submit">Aceptar</Button>

...
public class OrdenesDeCompraProveedorEntity {
    ...
    public OrdenesDeCompraProveedorEntity(int id_proveedor, String estado_pago, LocalDate fecha_pago, LocalDate fecha_entrega, LocalDate fecha_solicitud, String factura, int valor_pago, String estado_entrega) {

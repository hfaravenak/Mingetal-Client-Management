                              ...
                              <tr>
                                 <td>
                                    <Form.Group controlId="nombre">
                                       <Form.Control style={{ width: "100%" }} className="font-h2 no-border" type="text" value={input.nombre} onChange={handleInputChange} name="nombre" />
                                    </Form.Group>
                                 </td>
                                 <td>
                                    ...
                                    <Form.Group controlId="empresa_despacho">
                                       ...
                                       >
                                          ...
                                          {DespachoEntity.map((despacho) => (
                                             <option key={despacho.id_proveedor} value={despacho.empresa}>
                                                {despacho.empresa}
                                             </option>
                                          ))}
                                       </Form.Select>

...
function ListClienteComponents() {
   ...
   const generateRanking = () => {
      ClienteService.getRankingCliente()
         .then((res) => {
                     ...
                     <div className="inline-forms-container">
                        <Form className="inline-form">
                           <Form.Group controlId="rut">
                              ...
                              <Form.Control className="agregar" type="text" name="rut" placeholder="12.345.678-9" value={input.rut} onChange={handleInputChange} onKeyPress={handleKeyPressRut} />
                           </Form.Group>
                           ...
                           {ClienteEntity.map((cliente) => (
                              <tr key={cliente.rut}>
                                 ...
                                 <td style={{ textAlign: "center", verticalAlign: "middle", width: "1%" }}>
                                    <img id="editar" src={editar} alt="editar" onClick={() => ChangeViendoCliente(cliente)} />
                                 </td>
                              </tr>
                           ))}
                        </tbody>
         ...
         <div>
            ...
            <NavStyle>
               ...
               <div className="container">
                  <div className="container-1">
                     <div className="inline-forms-container">
                        <Form className="inline-form"></Form>
                        <Form className="inline-form"></Form>
                        <Form className="inline-form"></Form>
                     </div>
                     <div className="ranking-container">
